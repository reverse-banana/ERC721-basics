...
sepdep:
	@forge script script/DeployMoodNft.s.sol:DeployMoodNft --rpc-url $(SEP_RPC) --account main  --sender $(SENDER) --account $(ACCOUNT) --etherscan-api-key $(SEP_API) --broadcast --verify